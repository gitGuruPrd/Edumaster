...
public class CourseService {
    ...
    // modified this method according to the changes in feign package
...
//              = Boolean.TRUE.equals(restTemplate.getForEntity(resourceUrl, Boolean.class,orderRequest.getSkuCode(),orderRequest.getQuantity()).getBody());
        ...
        String userExistUrl="http://user-service/user/"+userId;
        boolean userExist=Boolean.TRUE.equals(restTemplate.getForEntity(userExistUrl,Boolean.class,entity).getBody());
        ...
        restTemplate.postForObject("http://payment-service/payment", 
                payment, 
                Payment.class);
